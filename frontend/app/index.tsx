    ...
    <SafeAreaView style={styles.container} testID="main-menu">
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.quickActions}>
          ...
          <TouchableOpacity style={[styles.actionBtn, isCompactMenu && styles.actionBtnCompact]} onPress={() => go("/achievements")} testID="achievements-btn"><Text style={styles.actionBtnText}>🏅 ACHV 🥇</Text></TouchableOpacity>
